...
# 時間
execute store result storage math:_ _ int 0.0000138889 run data get storage math: in
...
# 分
execute store result storage math:_ _ int 0.00083333334 run data get storage math: in
...
# 秒.ミリ秒
execute store result storage math:_ _ int 5 run data get storage math: in
execute store result score _ AiMath run data get storage math:_ _
